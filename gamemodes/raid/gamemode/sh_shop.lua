GM.Shop = {
	["Weapons"] = {
		...
		{ "Son Of Liberty", "weapon_raid_sonofliberty", 125 },
...
GM.Weapons = { -- second value is the danger level increase for each weapon
	...
	{ "weapon_raid_autoshotgun", 0.8},
	{ "weapon_raid_sauerkraut", 0.9},
	{ "weapon_raid_painkiller", 0.4},
	{ "weapon_raid_hosepipe", 0.5},
